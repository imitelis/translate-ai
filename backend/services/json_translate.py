...
def json_translate(input_sentence, source_lang, target_lang):
    # Load the JSON dictionary
    with open(f"../data/{source_lang}-{target_lang}.json") as json_file:
...
# print(json_translate('perro consume ALIMENTOS en Akiwi', 'es', 'en'))