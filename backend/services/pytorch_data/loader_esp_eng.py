...
encoder_path = os.path.join(current_dir, f"./models/{target_lang}-to-{base_lang}-encoder.pth")
decoder_path = os.path.join(current_dir, f"./models/{target_lang}-to-{base_lang}-decoder.pth")
